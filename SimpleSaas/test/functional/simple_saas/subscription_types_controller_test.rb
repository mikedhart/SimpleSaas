  ...
  class SubscriptionTypesControllerTest < ActionController::TestCase
    ...
    test "should create subscription_type" do
      assert_difference('SubscriptionType.count') do
        post :create, subscription_type: { cost: @subscription_type.cost, duration: @subscription_type.duration, name: @subscription_type.name }
      end
    ...
    test "should update subscription_type" do
      put :update, id: @subscription_type, subscription_type: { cost: @subscription_type.cost, duration: @subscription_type.duration, name: @subscription_type.name }
      assert_redirected_to subscription_type_path(assigns(:subscription_type))
    end
